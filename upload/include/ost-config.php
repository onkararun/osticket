...
define('SECRET_SALT','RRWzZr8rzYQykzW8BMsL6ydVAJq0ktXA');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','varun@vayudoot.in');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','vayudoot_sprt1');
define('DBUSER','vayudoot_sprt');
define('DBPASS','wFq&-G%nN*+7');
