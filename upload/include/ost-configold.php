...
define('SECRET_SALT','FyEGATGBE2rzpuGlccDhMABPVUvjkVDA');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','your@yourdomain.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','vayudoot_stc1');
define('DBUSER','vayudoot_stc1');
define('DBPASS','OvuOYXCJ4H');
